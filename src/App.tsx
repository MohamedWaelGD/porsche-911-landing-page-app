...
function PorscheHero() {
  ...
  useEffect(() => {
    let loadedFrames = 0;
    let cancelled = false;
    const totalFrames = FRAME_SEQUENCES.reduce(
      (total, sequence) => total + sequence.count,
      0,
    );
  ...
  useEffect(() => {
    ...
    const setCanvasSize = () => {
      ...
      canvases.forEach((canvas, index) => {
        ...
        drawCover(
          canvas,
          images[index][Math.round(frameRefs.current[index].frame)],
        );
      });
    };
    ...
    const ctx = gsap.context(() => {
      const animateCounters = (selector: string) => {
        gsap.utils.toArray<HTMLElement>(selector).forEach((counter) => {
          ...
          if (Number.isNaN(target) || counter.dataset.counted === "true")
            return;
      ...
      if (!reduceMotion) {
        ...
        timeline
          ...
          .call(
            () => animateCounters(".engineering-stats .count-up"),
            undefined,
            0.43,
          )
          .to(
          ...
          .to(
            ".hero-canvas[data-sequence='3']",
            { autoAlpha: 1, duration: 0.12 },
            0.64,
          )
          .to(
            ".story-panel[data-panel='3']",
            { autoAlpha: 1, y: 0, duration: 0.14 },
            0.68,
          )
          .to(
          ...
          .call(
            () => animateCounters(".performance-stats .count-up"),
            undefined,
            0.75,
          )
          .to(
    ...
    <>
      ...
      <section className="hero-scroll-section" id="hero" ref={sectionRef}>
        <div className="hero-sticky-stage">
          ...
          <main className="hero-content">
            <div className="story-panel hero-reveal" data-panel="1" id="models">
              ...
              <p className="hero-copy">
                Every curve, every detail, every piece. We don&apos;t just build
                cars, we perfect relentless performance.
              </p>
            ...
            <div className="story-panel" data-panel="2" id="design">
              ...
              <p className="hero-copy">
                ...
                <br />
                <br />
                The 911 is more than a car. It&apos;s the result of relentless
                engineering and an obsession with perfection.
              </p>
            ...
            <div className="story-panel performance-panel" data-panel="3">
              ...
              <p className="hero-copy hidden sm:block">
                The 911 Turbo combines iconic design with cutting-edge
                engineering. Every drive is a masterclass in power, control, and
                emotion.
              </p>
          ...
          <aside
            className="slide-index hero-reveal"
          ...
          <div
            className="hero-stats hero-reveal"
            aria-label="911 Turbo performance statistics"
          >
            {heroStats.map((stat) => (
...
function ExperienceSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.set(".experience-kicker, .experience-title, .experience-copy", {
        autoAlpha: 0,
        y: 24,
      });
      ...
      <div className="experience-shell">
        <div className="experience-topline">
          ...
          <p className="experience-copy">
            At Porsche, innovation is never an option, it&apos;s our obsession.
            From the racetrack to the road, every breakthrough is engineered to
        ...
        <div className="experience-bottomline">
          <blockquote className="experience-quote">
            ...
            <p>
              A Porsche is not just a car. It&apos;s a statement of who you are
              and how you drive the world.
            </p>
